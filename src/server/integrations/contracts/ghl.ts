...
export const GHL_PATH_PROVENANCE: Readonly<Record<string, string>> = {
  ...
  // Read off the create-key screen. Stronger evidence of existence than the
  // reference, and no evidence at all of shape.
  'api/v1/people/bulk_match': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/people/bulk_match': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/contacts/create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/contacts/create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/contacts/bulk_create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/contacts/bulk_create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/sequences/create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/sequences/create': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/sequences/update': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/sequences/update': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/emailer_campaigns/remove_or_stop_contact_ids': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/emailer_campaigns/remove_or_stop_contact_ids': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/emailer_campaigns/approve': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/emailer_campaigns/approve': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/emailer_campaigns/abort': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/emailer_campaigns/abort': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/email_accounts/index': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/email_accounts/index': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/email_domain_diagnosis/authentication_status': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/email_domain_diagnosis/authentication_status': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/usage_stats/credit_usage_stats': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/usage_stats/credit_usage_stats': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  'api/v1/usage_stats/api_usage_stats': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
  '/api/v1/usage_stats/api_usage_stats': 'Read off the endpoint list on the create-key screen of a real Apollo account, 1 September 2026. Confirms the endpoint exists and can be scoped to a key on that account. Says nothing about method, parameters or response.',
};
